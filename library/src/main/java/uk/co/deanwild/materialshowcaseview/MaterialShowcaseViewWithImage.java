 ...
 */
public class MaterialShowcaseViewWithImage extends FrameLayout implements View.OnTouchListener, View.OnClickListener {
   ...
   //private ImageView mContentTextView;
    ...
    List<IShowcaseImageListener> mListeners; // external listeners who want to observe when we show and dismiss
    ...
    public MaterialShowcaseViewWithImage(Context context) {
        super(context);
        init(context);
    }

    public MaterialShowcaseViewWithImage(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public MaterialShowcaseViewWithImage(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public MaterialShowcaseViewWithImage(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void init(Context context) {
        ...
        View contentView = LayoutInflater.from(getContext()).inflate(R.layout.showcase_image_content, this, true);
        mContentBox = contentView.findViewById(R.id.content_box);
        mTitleTextView = contentView.findViewById(R.id.tv_title);
        mContentImageView = contentView.findViewById(R.id.iv_content);
    ...
    private static final String TAG = MaterialShowcaseViewWithImage.class.getSimpleName();
    ...
    private void notifyOnDisplayed() {
        if (mListeners != null) {
            for (IShowcaseImageListener listener : mListeners) {
    ...
    private void setContentImage(int drawableId) {
        if (mContentImageView != null) {
            mContentImageView.setImageResource(drawableId);
        }
    }
    ...
    public void addShowcaseListener(IShowcaseImageListener showcaseListener) {
        if (mListeners != null)
    ...
    public static class Builder {
        ...
        final MaterialShowcaseViewWithImage showcaseView;
        ...
        public Builder(Activity activity) {
            ...
            showcaseView = new MaterialShowcaseViewWithImage(activity);
        }
        ...
        /**
         * Set the content image shown on the ShowcaseView.
         */
        public Builder setContentImage(int resId) {
            showcaseView.setContentImage(resId);
            return this;
        }
        ...
        public Builder setListener(IShowcaseImageListener listener) {
        ...
        public MaterialShowcaseViewWithImage build() {
        ...
        public MaterialShowcaseViewWithImage show() {
            build().show(activity);
            return showcaseView;
        }
    }
